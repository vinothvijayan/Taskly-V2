import { CheckSquare, ArrowDownLeftFromSquare, Play, Pause, Square } from 'lucide-react';
  ...
  return (
    <div className="h-full w-full bg-gray-900 text-gray-100 font-sans flex flex-col p-3 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto pr-1">
        <p className="text-xs font-semibold text-gray-400 mb-2 px-1">Today's Tasks</p>
