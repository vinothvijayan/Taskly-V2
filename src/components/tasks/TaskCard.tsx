          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0 space-y-2">
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex items-center gap-1 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  >
                    ...
                    {commentCount > 0 && (
                      <Badge variant="secondary" className="absolute -top-1 -right-2 h-4 min-w-[16px] justify-center p-0.5 text-[10px]">{commentCount}</Badge>
                    )}
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs">
                ...
                {typeof task.estimatedTime === 'number' && task.estimatedTime > 0 && <Badge variant="secondary"><Clock className="h-3 w-3 mr-1" />{task.estimatedTime}m</Badge>}
                {typeof task.timeSpent === 'number' && <Badge variant="outline"><Clock className="h-3 w-3 mr-1" />{formatTimeSpent(task.timeSpent)}</Badge>}
